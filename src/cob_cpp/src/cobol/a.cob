      ...
      * arrays
          01 ARRBS.
             05 ARRBSROW OCCURS 2 TIMES INDEXED BY ARRBSIDX.
                10 TBL0 BINARY-SHORT VALUE 9.
      *      05 ARRBSROW usage BINARY-SHORT occurs 4 times.
      * counter
          01 I PIC 9(01).
      *      05 ARRBSROW.
      *         10 TBL0 BINARY-SHORT VALUE 9.
      *         10 TBL0 BINARY-SHORT VALUE 8.
      *         10 TBL0 BINARY-SHORT VALUE 7.
      *         10 TBL0 BINARY-SHORT VALUE 6.
       LINKAGE SECTION.
       PROCEDURE DIVISION.
            DISPLAY 'cobf0'.
            DISPLAY '--------------------------------------------'
      ...
      *     test partoupper
            ...
            DISPLAY S000
      * c++ test (./src/cpp/a.cpp)
            CALL 'parvoid_cpp'
      * table test
      *     SET DATA-TABLE(1) TO 1.
            CALL 'pararrint' USING by reference ARRBS by reference 4
            CALL 'pararrint' USING by reference ARRBS by reference 4
            CALL 'pararrint' USING by reference ARRBS by reference 4
            DISPLAY ARRBS
            PERFORM VARYING I FROM 1 BY 1 UNTIL I > 6
                SET ARRBSIDX TO I
                DISPLAY ARRBS (STD-INDEX)
            END-PERFORM.
            EXIT PROGRAM.
